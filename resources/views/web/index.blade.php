	@include('web.layout.header')
				...
				<div class="container">
					<div class="row fullscreen d-flex align-items-center justify-content-center">
						<div class="banner-content col-lg-8">
							<h6 class="text-white">Inventário Arq Rio</h6>
							<h2 class="text-white">
								Arquidiocese do Rio de Janeiro				
							</h2>
							<a href="#" class="primary-btn text-uppercase">Confira as Obras</a>
						</div>											
					</div>
				</div>					
			</section>
			...
			<!-- Start service Area -->
			<section class="service-area pt-100" id="sobre-nos">
				<div class="container">
					<h1 class="mb-10 d-flex justify-content-center">Sobre o Projeto</h1>
					<div class="row">
						<div class="col-lg-4">
